...
class IncomesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create income" do
    assert_difference('Income.count') do
      post incomes_url, params: { income: { amount: @income.amount, description: @income.description, title: @income.title } }
    end
  ...
  test "should update income" do
    patch income_url(@income), params: { income: { amount: @income.amount, description: @income.description, title: @income.title } }
